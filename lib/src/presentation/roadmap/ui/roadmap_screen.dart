                              ...
                              showInfoBottomSheet(
                                ...
                                'Functional programming is a programming paradigm where computation is treated as the evaluation of mathematical functions, avoiding state and mutable data.',
                                {
                                  ...
                                  'Learn Functional Programming Concepts':
                                      'https://www.learn-c.org/en/Functional_programming',
                                },
                              );
                            },
                          ),
                        ...
                        MapItem(
                          ...
                          onTap: () {
                            showInfoBottomSheet(
                              ...
                              {
                                'Zapp! Documentation': 'https://www.zapp.io/',
                              },
                            );
                          },
                        ),
                            ...
                            MapItem(
                              ...
                              onTap: () {
                                showInfoBottomSheet(
                                  ...
                                  {
                                    'Observer Pattern in Dart':
                                        'https://dart.dev/guides/language/language-tour#streams',
                                ...
                                showInfoBottomSheet(
                                  ...
                                  'The Command pattern encapsulates a request as an object, allowing for parameterization of clients with queues, requests, and operations.',
                                  {
                                    'Command Pattern in Dart':
                                        'https://www.dartlang.org/guides/libraries/async',
                                ...
                                showInfoBottomSheet(
                                  ...
                                  'The Decorator pattern allows behavior to be added to an individual object dynamically without affecting the behavior of other objects from the same class.',
                                  {
                                    'Decorator Pattern in Dart':
                                        'https://dart.dev/guides/language/language-tour#mixins',
                            ...
                            MapItem(
                              ...
                              onTap: () {
                                showInfoBottomSheet(
                                  ...
                                  {
                                    'Composite Pattern in Dart':
                                        'https://dart.dev/guides/libraries/collections',
                                ...
                                showInfoBottomSheet(
                                  ...
                                  'Serializers are used to convert complex data types (like objects) into a format that can be easily saved (like JSON or XML) and later deserialized back into the original object.',
                                  {
                                    'Serialization in Dart':
                                        'https://dart.dev/guides/libraries/json',
                      ...
                      children: [
                        MapGroup(
                          ...
                          gridChildren: [
                            ...
                            MapItem(
                              icon: const Icon(FluentIcons.database_16_regular),
                              label: 'SQLite',
                              importantLevel: 2,
                              onTap: () {
                                showInfoBottomSheet(
                                ...
                                showInfoBottomSheet(
                                  ...
                                  'Profiling app performance involves measuring key metrics such as frame rates, CPU usage, and responsiveness to identify performance bottlenecks and optimize your app’s performance.',
                                  {
                                    'Flutter Performance Profiling':
                                        'https://flutter.dev/docs/testing/debugging#performance',
                            ...
                            MapItem(
                              ...
                              onTap: () {
                                showInfoBottomSheet(
                                  ...
                                  {
                                    'freeRASP Documentation':
                                        'https://github.com/Guard-Level/freeRASP',
                                    'freeRASP Setup Guide':
                                        'https://medium.com/@steven0510/free-rasp-mobile-application-security-framework-setup-guide-7c537f404707',
                                  },
                                );
                              },
                            ),
                            ...
                            MapItem(
                              ...
                              onTap: () {
                                showInfoBottomSheet(
                                  ...
                                  {
                                    'Dart VM Official Documentation':
                                        'https://dart.dev/guides/dart-vm',
                                    'Dart Virtual Machine Overview':
                                        'https://www.dartlang.org/guides/architecture/virtual-machine',
                                  },
                                );
                              },
                            ),
                                ...
                                showInfoBottomSheet(
                                  ...
                                  'RenderObjects are the core components responsible for rendering UI elements in Flutter. They manage layout, painting, and interaction handling for widgets in the app.',
                                  {
                                    'RenderObjects in Flutter':
                                        'https://flutter.dev/docs/development/ui/advanced/rendering',
                                    'Flutter Rendering Pipeline':
                                        'https://medium.flutterdevs.com/understanding-the-flutter-rendering-pipeline-6a5245baec65',
                                  },
                                );
                              },
                            ),
                                ...
                                showInfoBottomSheet(
                                  ...
                                  'Flutter is not just for mobile apps. It also supports building apps for desktop platforms (macOS, Windows, Linux) and web browsers, allowing you to use a single codebase to target multiple platforms.',
                                  {
                                    ...
                                    'Building Desktop Apps with Flutter':
                                        'https://medium.flutterdevs.com/building-desktop-apps-with-flutter-27b340d4f207',
                                  },
                                );
                              },
                            ),
                            MapItem(
                              ...
                              onTap: () {
                                showInfoBottomSheet(
                                  ...
                                  {
                                    'Server-side Dart Documentation':
                                        'https://dart.dev/guides/server',
                                    'Building Server Apps with Dart':
                                        'https://medium.flutterdevs.com/building-server-apps-with-dart-c8e6c7c4c81b',
                                  },
                                );
                              },
                            ),
